	...
	<div class="satu">
		<div class="satu-img">
            <table align = 'center'>
                <tr>
                    <td width = '341'>
                        <form action = "1-columnKom.php" method = "POST">
                            <table>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width ='200'>  
                                        <select name = "criteria" required>
                                            ...
                                            <option value = "contact_person">Narahubung</option>
                                        </select>
                                    </td>
                                    <td width = '220'>
            ...
            <?php 
                function printOut($response) {
                    ...
                    echo "<table align = 'center'>";
                        echo "<tr>
                            <td width = '300'><b>NAMA LEMBAGA</b></td>
                            <td width = '200'><b>DESKRIPSI</b></td>
                            <td width = '300'><b>ALAMAT</b></td>
                            <td width = '150'><b>NARAHUBUNG</b></td>
                    ...
                    foreach ($response as $data) {
                        ...
                        echo $data['data']['nama_lembaga'];
                        echo "</td>";

                        echo "<td align ='left' style = 'vertical-align : top'>";
                        echo $data['data']['deskripsi'];
                        echo "</td>";
                        ...
                        echo "<td style = 'vertical-align : top'>";
                        echo $data['data']['contact_person'];
                        echo "</td>";

                        echo "<td style = 'vertical-align : top'>";
                        echo $data['data']['nomor_telepon'];
                        echo "</td>";
                ...
                if(isset($_POST["action"])) {
                    ...
                    echo "<hr>";
                    if($action === "search") {
                        $url = "http://localhost/komunitas/api2.php?action=search&criteria=" . $_POST["criteria"];
                        ...
                        if($action === "sort") {
                            $url = "http://localhost/komunitas/api2.php?action=sort&criteria=" . $_POST["criteria"] . "&order=" . $_POST["order"];
                            $response = file_get_contents($url);
                            $response = json_decode($response, true);
                            printOut($response);
                        } else {
